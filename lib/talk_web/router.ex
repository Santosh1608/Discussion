defmodule TalkWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {TalkWeb.LayoutView, :root}
    plug :protect_from_forgery
    plug :put_secure_browser_headers
    plug TalkWeb.Plugs.SetUser
    plug :put_user_token
  end
  ...
  scope "/", TalkWeb do
    ...
    get "edit/:id", TopicController, :edit
    get "/:id", TopicController, :show
  end

  scope "/auth", TalkWeb do
    pipe_through :browser
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: TalkWeb.Telemetry
    end
  end
